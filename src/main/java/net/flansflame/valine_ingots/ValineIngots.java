...
import net.flansflame.valine_ingots.blocks.ModBlockEntities;
import net.flansflame.valine_ingots.entities.ModEntities;
import net.flansflame.valine_ingots.items.ModCreativeModeTabs;
import net.flansflame.valine_ingots.items.ModItems;
import net.flansflame.valine_ingots.recipe.ModRecipes;
