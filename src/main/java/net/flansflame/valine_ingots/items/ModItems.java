package net.flansflame.valine_ingots.items;

import net.flansflame.flans_knowledge_lib.tool_set.CustomToolSets;
import net.flansflame.valine_ingots.ValineIngots;
import net.flansflame.valine_ingots.items.item.MysteriousGlove;
import net.flansflame.valine_ingots.items.item.UpgradeArmorItem;
import net.flansflame.valine_ingots.toolsets.ModToolSets;
import net.flansflame.valine_ingots.items.item.PaxelItem;
import net.flansflame.valine_ingots.toolsets.toolset.UpgradeSwordItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MYSTERIOUS_GLOVE = ITEMS.register("mysterious_glove",
            () -> new MysteriousGlove(new Item.Properties().stacksTo(1)));
