...
public class LaserTurretRenderer<T extends LaserTurretEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public LaserTurretRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends LaserTurretEntity> extends GeoModel<T> {
        @Override
