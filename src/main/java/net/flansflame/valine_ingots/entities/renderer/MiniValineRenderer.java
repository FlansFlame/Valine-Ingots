...
public class MiniValineRenderer<T extends MiniValineEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public MiniValineRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends MiniValineEntity> extends GeoModel<T> {
        @Override
