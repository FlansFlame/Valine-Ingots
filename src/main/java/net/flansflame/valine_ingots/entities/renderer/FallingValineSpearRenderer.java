...
public class FallingValineSpearRenderer<T extends FallingValineSpearEntity> extends GeoEntityRenderer<T> {

    private static String ID;

    public FallingValineSpearRenderer(EntityRendererProvider.Context renderManager, String id) {
    ...
    public static class Model<T extends FallingValineSpearEntity> extends GeoModel<T> {
        @Override
